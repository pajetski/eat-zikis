      ...
      <section className="catering" id="inquire">
        ...
        >
          ...
          <div className="form-heading">
            ...
            <p>
              Share what you know now. We’ll follow up to shape the menu,
              service, and details together.
            </p>
          </div>
          ...
          <div className="form-submit">
            <p>
              Your inquiry will be securely saved in Netlify for the Ziki’s
              team to review.
            </p>
            <button className="button button-dark" type="submit">
              Send event inquiry <span aria-hidden="true">↗</span>
            </button>
          </div>
        </form>
